...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-wasi' '--build' 'arm64-apple-darwin23' '--with-static-linked-ext' '--with-ext=bigdecimal,cgi/escape,continuation,coverage,date,dbm,digest/bubblebabble,digest,digest/md5,digest/rmd160,digest/sha1,digest/sha2,etc,fcntl,fiber,gdbm,json,json/generator,json/parser,nkf,objspace,pathname,psych,racc/cparse,rbconfig/sizeof,ripper,stringio,strscan,monitor,zlib,openssl' '--with-libyaml-dir=/Users/logiteca7/repos/wasm-learning/samples/b4/build/wasm32-unknown-wasip1/yaml-0.2.5/opt/usr/local' '--with-zlib-dir=/Users/logiteca7/repos/wasm-learning/samples/b4/build/wasm32-unknown-wasip1/zlib-1.3.1/opt/usr/local' '--with-openssl-dir=/Users/logiteca7/repos/wasm-learning/samples/b4/build/wasm32-unknown-wasip1/openssl-3.2.0/opt/usr/local' '--with-baseruby=/Users/logiteca7/repos/wasm-learning/samples/b4/build/arm64-apple-darwin23/baseruby-3.3/opt/bin/ruby' 'WASMOPT=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/binaryen/bin/wasm-opt' 'WASI_SDK_PATH=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk' 'CC=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang' 'CXX=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang++' 'LD=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang' 'AR=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/llvm-ar' 'RANLIB=/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/llvm-ranlib' 'LDFLAGS=-Xlinker --stack-first -Xlinker -z -Xlinker stack-size=16777216' 'XLDFLAGS=/Users/logiteca7/repos/wasm-learning/samples/b4/build/wasm32-unknown-wasip1/wasi-vfs-0.5.0/libwasi_vfs.a' 'CFLAGS=' 'XCFLAGS=-DWASM_SETJMP_STACK_BUFFER_SIZE=24576 -DWASM_FIBER_STACK_BUFFER_SIZE=24576 -DWASM_SCAN_STACK_BUFFER_SIZE=24576' 'debugflags=-g' 'cppflags=' 'wasmoptflags=-O3 -g --pass-arg=asyncify-ignore-imports' '--disable-install-doc' 'ac_cv_func_dlopen=no' 'build_alias=arm64-apple-darwin23' 'host_alias=wasm32-wasi'"
  ...
  CONFIG["RANLIB"] = "/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/llvm-ranlib"
  CONFIG["OBJDUMP"] = "objdump"
  CONFIG["OBJCOPY"] = ":"
  CONFIG["NM"] = "nm --no-llvm-bc"
  CONFIG["LD"] = "/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang"
  CONFIG["CXX"] = "/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang++"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/llvm-ar"
  CONFIG["CC"] = "$(CC_WRAPPER) /Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/wasi-sdk/bin/clang"
  CONFIG["wasmoptflags"] = "-O3 -g --pass-arg=asyncify-ignore-imports"
  CONFIG["WASMOPT"] = "/Users/logiteca7/repos/wasm-learning/samples/b4/build/toolchain/binaryen/bin/wasm-opt"
